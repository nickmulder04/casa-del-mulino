const sharedPairings = [
  ...
  {
    title: "Tiramisu",
    image: "assets/images/casa-del-mulino-flessen.jpg",
...
const products = {
  limoncello: {
    ...
    gallery: ["assets/images/product-limoncello.jpg", "assets/images/limoncello-fles.jpg", "assets/images/hero-limoncello-citrus-trees.jpg", "assets/images/limoncello-citrus-still-life.jpg"],
    accent: "#d9b72f",
    alcohol: "30% vol",
    size: "500 ml",
    fruit: "Citroen",
  ...
  arancello: {
    ...
    image: "assets/images/product-arancello.jpg",
    gallery: ["assets/images/product-arancello.jpg", "assets/images/arancello-fles.jpg", "assets/images/limoncello-arancello-case.jpg", "assets/images/product-collection-three.jpg"],
    accent: "#cf7228",
    alcohol: "30% vol",
    size: "500 ml",
    fruit: "Sinaasappel",
  ...
  meloncello: {
    ...
    gallery: ["assets/images/product-meloncello.jpg", "assets/images/meloncello-fles.jpg", "assets/images/product-collection-three.jpg", "assets/images/casa-del-mulino-flessen.jpg"],
    accent: "#71925a",
    alcohol: "30% vol",
    size: "500 ml",
    fruit: "Meloen",
